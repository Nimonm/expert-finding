...
# model_lgb = LGBMClassifier(boosting_type='gbdt', num_leaves=36, learning_rate=0.05, n_estimators=5000,
#                            max_bin=128, subsample_for_bin=50000, objective='binary', min_split_gain=0,
...
#
# cb_model = GridSearchCV(cb, params, n_jobs=1, scoring="roc_auc", cv = 5)
...
# print_best_score(cb_model, params)
...
sub.to_csv('JSQ.txt', index=None, header=None, sep='\t')